...
KnownOperators::KnownOperators()
{
    ...
    KnownOperators::operators1ArgsFunctionMap.insert(std::make_pair<std::string, std::function<double(double)>>("sin", sin));
    KnownOperators::operators1ArgsFunctionMap.insert(std::make_pair<std::string, std::function<double(double)>>("cos", cos));
