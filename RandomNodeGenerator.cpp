...
const std::string& RandomNodeGenerator::getRandomOperator1Arg() const
{
...
const std::string& RandomNodeGenerator::getRandomOperator2Args() const
{
    const std::vector<std::string>& operators = KnownOperators::getKnownOperators()->getOperators2Args();
    return operators[Helper::getRandomNumber()%operators.size()];
}

AbstractExpressionNode* RandomNodeGenerator::getRandomVariable(const std::map<std::string, int>& variablesMap) const
{
...
AbstractExpressionNode* RandomNodeGenerator::fillNode(AbstractExpressionNode* nodeToFill, const std::map<std::string, int>& variablesMap) const
{
...
AbstractExpressionNode* RandomNodeGenerator::getRandomNode() const
{
...
AbstractExpressionNode* RandomNodeGenerator::getRandomLeaf(const std::map<std::string, int>& variablesMap) const
{
    if(Helper::getRandomNumber()%2)
        return new Constant(Helper::getRandomNumber());
...
AbstractExpressionNode* RandomNodeGenerator::getRandomLeafOrNode(const std::map<std::string, int>& variablesMap) const
{
    if(Helper::getRandomNumber()%2)
